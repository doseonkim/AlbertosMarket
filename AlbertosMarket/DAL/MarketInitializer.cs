...
namespace AlbertosMarket.DAL
{
    public class MarketInitializer : System.Data.Entity.DropCreateDatabaseIfModelChanges<MarketContext>
    {
        protected override void Seed(MarketContext context)
        {
            ...
            {
            new Comment{CommentID=1, MarketID=1,Content="You suck alberto", Author="Akshay", CommentDate=DateTime.Parse("2005-09-02")},
            new Comment{CommentID=2, MarketID=1,Content="$500", Author="Doseon", CommentDate=DateTime.Parse("2005-09-03")}
            };
